# Verify that the user is redirects to the Notification page
...
if "dashboard" in current_url:
    ...
    time.sleep(3)
    driver.find_element(By.LINK_TEXT,'Notification').click()
    current_url_notifications = driver.current_url
    if 'notifications' in current_url_notifications:
        time.sleep(2)
        print('User successfully redirected to the notifications page')
    else:
        print('User does not redirected to the notifications page')
