# Verify that the user is redirects to the explore properties (Home) page
...
if "dashboard" in current_url:
    ...
    current_url_HomePage = driver.current_url

    if 'HomePage' in current_url_HomePage:
        print('The user successfully redirected to the home page')
    else:
        print("The user does not redirected to the home page")
else:
